...
///     <para>
///         This interface is to be used solely when dealing with exceptions that can either be safely ignored and should
///         only be reported to a logging service, or
///         have handling at a lower level.
///     </para>
///     <para>
///         A common use case for this should be for safe disposal of exceptions on fire-and-forget tasks that should not
