...
public abstract partial class SynchronizationContextInvokerBase
{
    ...
    {
        var outerState = new Tuple<Action<TParam1>, Tuple<TParam1>>(action, new(param1));
    ...
    {
        var outerState = new Tuple<Action<TParam1, TParam2>, Tuple<TParam1, TParam2>>(action, new(param1, param2));
    ...
    {
        var outerState = new Tuple<Action<TParam1, TParam2, TParam3>, Tuple<TParam1, TParam2, TParam3>>(action, new(param1, param2, param3));
    ...
    {
        var outerState = new Tuple<Action<TParam1, TParam2, TParam3, TParam4>, Tuple<TParam1, TParam2, TParam3, TParam4>>(action, new(param1, param2, param3, param4));
    ...
    {
        var outerState = new Tuple<Action<TParam1, TParam2, TParam3, TParam4, TParam5>, Tuple<TParam1, TParam2, TParam3, TParam4, TParam5>>(action, new(param1, param2, param3, param4, param5));
    ...
    {
        var outerState = new Tuple<Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>, Tuple<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>>(action, new(param1, param2, param3, param4, param5, param6));
    ...
    {
        var outerState = new Tuple<Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>, Tuple<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>>(action, new(param1, param2, param3, param4, param5, param6, param7));
    ...
    {
        var outerState = new Tuple<Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8>, Tuple<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8>>(action, new(param1, param2, param3, param4, param5, param6, param7, param8));
