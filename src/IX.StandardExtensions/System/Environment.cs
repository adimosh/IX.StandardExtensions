...
{
    /// <summary>
    /// Concrete implementation of the abstraction over the <see cref="GlobalSystem.Environment"/> class. This class cannot be inherited.
    /// </summary>
    ...
    public sealed class Environment : IEnvironment
    {
        ...
        public IDictionary<string, string> GetEnvironmentVariables() =>
            GlobalSystem.Environment.GetEnvironmentVariables()
                .OfType<GlobalSystem.Collections.DictionaryEntry>()
                .ToDictionary(
        ...
        public IDictionary<string, string>
            GetEnvironmentVariables(GlobalSystem.EnvironmentVariableTarget target) =>
        ...
        public string ExpandEnvironmentVariables(string name) =>
            GlobalSystem.Environment.ExpandEnvironmentVariables(name);
