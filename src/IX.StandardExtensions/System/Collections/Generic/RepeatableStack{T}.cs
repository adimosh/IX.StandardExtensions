...
#region Properties and indexers
        ...
        public int Count =>
            ((IReadOnlyCollection<T>)this.internalStack).Count;
...
#region Interface implementations
        ...
        public IEnumerator<T> GetEnumerator() =>
            this.internalStack.GetEnumerator();
        ...
        public bool Contains(T item) =>
            this.internalStack.Contains(item);
        ...
        public void PushRange(T[] items) =>
            this.internalStack.PushRange(items);
        ...
        public bool TryPeek(out T item) =>
            this.internalStack.TryPeek(out item);
